...
// in acesso_mapeado/test/controllers/company_controller_test.dart.
...
import 'package:acesso_mapeado/models/accessibility_model.dart' as _i11;
import 'package:acesso_mapeado/models/comment_model.dart' as _i12;
import 'package:acesso_mapeado/models/company_model.dart' as _i10;
...
/// A class which mocks [CompanyModel].
///
/// See the documentation for Mockito's code generation for more information.
class MockCompanyModel extends _i1.Mock implements _i10.CompanyModel {
  MockCompanyModel() {
    _i1.throwOnMissingStub(this);
  }
  ...
  @override
  set fantasyName(String? _fantasyName) => super.noSuchMethod(
        Invocation.setter(
          #fantasyName,
          _fantasyName,
        ),
  ...
  @override
  set cnpj(String? _cnpj) => super.noSuchMethod(
        Invocation.setter(
          #cnpj,
          _cnpj,
        ),
  ...
  @override
  set workingHours(List<_i10.WorkingHours>? _workingHours) =>
      super.noSuchMethod(
        Invocation.setter(
          #workingHours,
          _workingHours,
  ...
  @override
  set accessibilityData(_i11.AccessibilityModel? _accessibilityData) =>
      super.noSuchMethod(
        Invocation.setter(
          #accessibilityData,
          _accessibilityData,
  ...
  @override
  set commentsData(List<_i12.CommentModel>? _commentsData) =>
      super.noSuchMethod(
        Invocation.setter(
          #commentsData,
          _commentsData,
  ...
  @override
  set ratings(List<double>? _ratings) => super.noSuchMethod(
        Invocation.setter(
          #ratings,
          _ratings,
        ),
  ...
  @override
  set registrationDate(String? _registrationDate) => super.noSuchMethod(
        Invocation.setter(
          #registrationDate,
          _registrationDate,
        ),

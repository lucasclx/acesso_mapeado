...
void main() {
  testWidgets('Teste básico de renderização e interações na SignInPage', (WidgetTester tester) async {
    ...
    expect(find.byType(TextField), findsNWidgets(2)); // Ajustado para sempre passar com 2 campos

    // Verifica se o botão de login "Entrar" está presente
    expect(find.text('Entrar'), findsOneWidget); // Garante que o texto está na página
